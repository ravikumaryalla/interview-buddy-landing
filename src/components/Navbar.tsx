      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center gap-2">
            ...
            <span className="font-bold text-gray-900 text-lg tracking-tight">{config.app.name}</span>
          </Link>
          ...
          <div className="hidden md:flex items-center gap-3">
            <Link to="/login" className="text-sm text-gray-700 hover:text-violet-600 font-medium transition-colors">
              Sign in
            </Link>
            <Link
              to="/login"
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="pt-2 flex flex-col gap-2">
                <Link
                  ...
                  className="text-sm text-center bg-violet-600 hover:bg-violet-700 text-white font-medium px-4 py-2 rounded-lg transition-colors"
                >
